    ...
    <x-filament::section>
        <div class="space-y-6 px-6 py-12 lg:px-8">
            ...
            @foreach ($this->getPlans() as $plan)
                <div
                    x-data="{ more: false, addOnMore: false }"
                ...
                >
                        ...
                        <div class="pb-8 sm:pb-10">
                            ...
                            >
                                ...
                                <span x-show="{{ \Illuminate\Support\Js::from($plan->selfFeatures()->count() > 6) }}">
                                    <svg
                                        x-show="!more"
                                        class="h-6 w-5 flex-none text-gray-600 hover:text-indigo-600"
                            ...
                            @if ($plan->addOnFeatures()->count())
                                ...
                                >
                                    ...
                                    <div class="h-px flex-auto bg-gray-100"></div>
                                    <span
                                        x-show="{{ \Illuminate\Support\Js::from($plan->addOnFeatures()->count() > 4) }}"
                                    >
                                        <svg
                                            x-show="!addOnMore"
                                            class="h-6 w-5 flex-none text-gray-600 hover:text-indigo-600"
                    ...
                    <div class="sticky top-16 -mt-2 p-2 lg:mt-0 lg:h-full lg:w-full lg:max-w-md lg:flex-shrink-0">
                        <div
