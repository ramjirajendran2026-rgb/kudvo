    ...
    @foreach($election->positions as $position)
        <table class="pos-tbl">
            ...
            <tr>
                <th colspan="3">
                    {{ $position->name }}<br>
                    <small>{{ str(string: $position->quota.' post')->plural(count: $position->quota) }}</small>
                </th>
            </tr>
            </thead>
            <tbody>
            ...
            @empty
                <tr>
                    <td colspan="3" style="padding: 6mm; text-align: center; vertical-align: middle;">None selected</td>
                </tr>
            @endforelse
            </tbody>
        </table>
