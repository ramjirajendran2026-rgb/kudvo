<main class="pg-wiki pg-show h-full w-full">
    ...
    <section class="py-6 container bg-primary-50 md:rounded-t-3xl space-y-6">
            ...
            <ol class="flex flex-wrap items-center gap-x-2">
                <li class="flex gap-x-2">
                    <x-filament::icon
                        ...
                        class="flex h-5 w-5 text-gray-400"
                    />

                    <a
                        href="{{ route('wiki.index') }}"
                        class="text-sm font-medium text-gray-500 transition duration-75 hover:text-gray-700"
                    >
                        Home
                    </a>
                </li>
        ...
        <div class="flex flex-col md:flex-row gap-6">
            <div class="flex-1 space-y-6">
                <div class="bg-white shadow-sm ring-1 rounded-xl ring-gray-950/5 p-6">
                    <article class="prose max-w-full lg:prose-lg">
            ...
            <div class="space-y-6 w-full md:max-w-xs">
                @if($this->categories->count())
                    <section
                        class="bg-white shadow-sm ring-1 rounded-xl ring-gray-950/5">
