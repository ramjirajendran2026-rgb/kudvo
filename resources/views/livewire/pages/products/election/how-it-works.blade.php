<main class="pg-el pg-hiw h-full w-full">
    <section
        ...
        style="background-image: url('{{ __('pages/products/election/how-it-works.content.hero.bg_image') }}')"
    >
        <div
    ...
    <section id="video" class="py-16">
        <div class="container">
            <video class="mx-auto w-full max-w-screen-lg rounded-2xl" autoplay muted loop>
                <source src="{{ __('pages/products/election/how-it-works.content.video.url') }}" type="video/mp4" />
