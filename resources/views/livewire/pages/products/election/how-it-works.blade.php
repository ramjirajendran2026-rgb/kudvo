<main class="pg-el pg-hiw h-full w-full">
    ...
    <section class="container mx-auto w-full" id="online-voting-video">
        <div class="relative">
            <main
                class="relative flex flex-col justify-center overflow-hidden bg-slate-50 md:flex-row"
            >
                <div
                    class="mx-auto w-full max-w-6xl px-4 py-6 md:px-6 md:py-12"
                >
                    <div class="flex justify-center">
                        ...
                        >
                            ...
                            >
                                <img
                                    class="rounded-3xl"
                                    src="{{ asset('img/products/election/how-to-setup-email-online-election.webp') }}"
                                    width="768"
                                    height="432"
                                    alt="email online voting video thumbnail"
                                />
                                <!-- Play icon -->
                                <svg
                    ...
                    <div class="flex justify-center">
                        ...
                        >
                            ...
                            >
                                <img
                                    class="rounded-3xl"
                                    src="{{ asset('img/products/election/how-to-setup-sms-online-election.webp') }}"
                                    width="768"
                                    height="432"
                                    alt="sms online voting video thumbnail"
                                />
                                <!-- Play icon -->
                                <svg
                                    class="pointer-events-none absolute transition-transform duration-300 ease-in-out group-hover:scale-110"
