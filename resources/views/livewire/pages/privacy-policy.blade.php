<main class="container prose py-8">
    ...
    <ul>
        ...
        <li>
            <p>
                ...
                this Agreement) refers to iNodesys Technologies, 117, Y Block Main Street, Anna Nagar, Chennai - 600040.
            </p>
        </li>
        <li>
            <p>
        ...
        <li>
            <p>
                ...
                refers to Kudvo, accessible from
                <a href="https://kudvo.com" rel="external nofollow noopener" target="_blank">https://kudvo.com</a>
            </p>
        </li>
        <li>
            <p>
    ...
    <ul>
        ...
        <li>
            <p>
                ...
                to manage Your registration as a user of the Service. The Personal Data You provide can give You access
    ...
    <ul>
        ...
        <li>
            <p>
                ...
                <a href="https://kudvo.com/#contact" rel="external nofollow noopener" target="_blank">
                    https://kudvo.com/#contact
                </a>
            </p>
        </li>
    </ul>
